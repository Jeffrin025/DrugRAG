...
**RELEVANT INFORMATION FROM THE DRUG LABEL(S):**
{retrieved_info}
...
4.  **Precise Citation:** On a new line, state: "This information comes from:" followed by a CONSOLIDATED and precise list of sources.
    -   **CONSOLIDATE:** Analyze the provided context. Identify the PRIMARY source where the core answer is definitively stated. Cite ONLY that primary, definitive source.
...
-   **DO NOT** assume the question is about any specific drug unless explicitly mentioned in the question or context.
